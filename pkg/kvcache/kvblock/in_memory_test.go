...
func TestInMemoryIndexSize(t *testing.T) {
	...
	assert.Contains(t, podsPerKey[key2], "pod2@gpu")
	assert.Contains(t, podsPerKey[key3], "pod3@cpu")
}
...
func TestInMemoryIndexPodCacheSize(t *testing.T) {
	...
	assert.Contains(t, podsPerKey[key], "pod2@gpu")
	assert.Contains(t, podsPerKey[key], "pod3@cpu")
}
