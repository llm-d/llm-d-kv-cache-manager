...
The KVCache is designed to connect high-level serving-stack goals with concrete system capabilities 
...
To implement this vision, the KVCache incorporates proactive cache placement, session duplication, 
