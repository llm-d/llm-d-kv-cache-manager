...
func main() {
	defaultPod := []string{"pod-1", "pod-2", "pod-3"}
	serverAddr := flag.String("server", "localhost:50051", "gRPC server address")
	prompt := flag.String("prompt", testdata.Prompt, "Test prompt")
	modelName := flag.String("model", testdata.ModelName, "Model name")
	flag.Parse()
	...
	req := getPodScoresRequest(*prompt, *modelName, defaultPod)
